...
AUDIO_FILE = "input/kubo-converted.mp4"
mkdir_safe("output")
OUTPUT_FILE_PREFIX = "output/summaries2"  # will do .json, .csv sepately
...
def main():
    ...
    # TODO: We should re-order the columns, and reformat a list of strings (remove brackets)
    ...
    prioritized_people = sorted(summaries, key=lambda x: x['priority'], reverse=True)
    todo_list = []
    ...
    write_to_csv(todo_list, f"{OUTPUT_FILE_PREFIX}-todo.csv")
