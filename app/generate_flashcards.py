...
def generate_page(template_path, page_title, summaries=None, todo_list=None):
    ...
    for i, person in enumerate(summaries):
        ...
        body = {
            ...
            "person_body.from": person.get("from"),
